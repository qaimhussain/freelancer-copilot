...
Built in one night as part of **Comeback Pakistan Cohort 1**.
...
**knowledge_base** — stores winning proposals automatically via Make.com automation, used to improve future recommendations over time
...
- Tables: freelancers, proposals, knowledge_base
- Docs: supabase.com/docs

**Make.com**
- Used for: automation trigger when a proposal is marked as Won
- Workflow: Supabase webhook → filter for outcome = won → insert into knowledge_base
- Docs: make.com
...
This is a working prototype built to validate the concept. It is not the final product. Full product direction is being decided with the Comeback Pakistan squad.

---

*Built by Qaim Hussain — Embedded Systems & Security student at Air University Islamabad, freelance video editor, Comeback Pakistan Cohort 1*
